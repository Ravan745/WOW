          ...
          return message.reply({
            embeds: [
              this.client.utils
                ...
                .setDescription(
                  `${this.client.emoji.tick} Successfully **Added** [Premium](${this.client.config.server}) to ${guild.name} by **${message.author.username}**\nExpires On: <t:${premTime}> (<t:${premTime}:R>)\nExecutive Code: \`${code.CODE}\``
                ),
            ],
          });
        }
          ...
          return message.reply({
            embeds: [
              this.client.utils
                ...
                .setTitle(`Premium Not Found`)
                .setDescription(
                  `${this.client.emoji.cross} User ${user.username} don't have any kind of [Premium](${this.client.config.server}).Please visit our [Support Server](${this.client.config.server}) to avail your Premium today!`
                )
                .setTimestamp()
                .setAuthor({
                  name: `${this.client.user.username}`,
          ...
          return message.reply({
            embeds: [
              this.client.utils
                ...
                .setDescription(
                  `${this.client.emoji.tick} Successfully **Revoked** [Premium](${this.client.config.server}) for the guild by **${message.author.username}**`
                )
                .setTimestamp(),
            ],
          });
