    ...
    this.run = async (message: any) => {
      ...
      if (mention && checkGlobalAfk(mention?.id) === true) {
        ...
        return message.reply({
          content: `**${mention?.username}** is Globally Afk since: **<t:${get.TIME}:R>** for reason: ${get.REASON}`,
      ...
      if (
        ...
        return message.reply({
          content: `**${mentionMember?.user.username}** is Afk since: **<t:${get.TIME}:R>** for reason: ${get.REASON}`,
