        ...
        return message.reply({
          embeds: [
            this.client.utils
              ...
              .setDescription(
                `${this.client.emoji.cross} This user ${user.username} is not a Premium User!`
              ),
          ],
        });
      else {
          ...
          return message.reply({
            embeds: [
              this.client.utils
                ...
                .setDescription(
                  `${this.client.emoji.tick} Successfully **Removed** [Premium](${this.client.config.server}) from **${user.username}**`
                )
                .setTimestamp()
                .setAuthor({
                  name: `${this.client.user.username}`,
